...
class PageController extends _CrudController
{
    ...
    public function edit($id)
    {
        ...
        if($getData->key == 'homepage') {
            ...
            $getData->landingpage_background = asset($getValue['landingpage_background']) ?? asset('assets/cms/images/no-img.png');
            $getData->homepage_title = $getValue['homepage_title'] ?? null;
            $getData->homepage_content = $getValue['homepage_content'] ?? null;
            $getData->homepage_background = asset($getValue['homepage_background']) ?? asset('assets/cms/images/no-img.png');
            $getData->about_image = asset($getValue['about_image']) ?? asset('assets/cms/images/no-img.png');
            $getData->about_title = $getValue['about_title'] ?? null;
            $getData->about_content = $getValue['about_content'] ?? null;
            $getData->contact_logo = asset($getValue['contact_logo']) ?? asset('assets/cms/images/no-img.png');
