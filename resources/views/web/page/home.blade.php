...
@section('css')
    ...
    <style>
        #landing {
            background: url("{{ asset($homepage['landingpage_background']) ?? asset('assets/cms/images/no-img.png') }}");
            background-size: cover;
            min-height: 100vh;
        }

        #home {
            background: linear-gradient(rgba(0, 0, 0, .4), rgba(0, 0, 0, .4)), url("{{ asset($homepage['homepage_background']) ?? asset('assets/cms/images/no-img.png') }}");
            background-size: cover;
            min-height: 100vh;
        }
